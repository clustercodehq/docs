...
<ThemedImage
  ...
  title="DevBoxes"
  alt="The DevBoxes page listing running and stopped DevBoxes across workers, each card showing the container name, ticket title, branch, capability badges, CPU/memory/disk usage, host worker, and a terminal launcher."
/>

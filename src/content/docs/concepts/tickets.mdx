...
4. A **DevBox launches** on the worker you selected — or, on auto-select, one
   chosen by the [placement rules](/concepts/schedules#how-a-target-is-chosen) —
   with the repo cloned and the agent CLI ready
